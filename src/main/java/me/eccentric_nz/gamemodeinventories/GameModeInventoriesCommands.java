                ...
                if (args.length == 1 && firstArgs.containsKey(option)) {
                                    ...
                                    + plugin.getPrefix() + "inventories WHERE uuid = ? AND gamemode = 'SURVIVAL'");)
                    {
                        ...
                        if (args[1].toLowerCase().equals("save")) {
                            ...
                            String inv = GameModeInventoriesBukkitSerialization
                                    .toDatabase(p.getInventory().getContents());
                            ...
                            // load
                            try (PreparedStatement loadStatement = connection
                                    .prepareStatement("SELECT " + plugin.getPrefix()
